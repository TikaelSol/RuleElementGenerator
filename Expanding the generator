...
* Add the new option as an argument for Prepare Options()
* - Add a new step in the PrepareOptions() to format the option correctly.  Follow the exiisting steps as an example.
